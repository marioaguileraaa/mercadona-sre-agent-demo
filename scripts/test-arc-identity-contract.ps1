...
Assert-NotMatches -Source $retailConfigureSource -Pattern '(?m)^\s+azMonitorFilterSettings\s*=' -Case 'Retail filter omits the rejected azMonitorFilterSettings field'
